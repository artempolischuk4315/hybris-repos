...
/**
 * This is the extension manager of the Myext extension.
 */
public class MyextManager extends GeneratedMyextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MyextManager.class);
	 ...
	 */
	public static MyextManager getInstance()
	{
		return (MyextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MyextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MyextManager() // NOPMD 
	{
		LOG.debug("constructor of MyextManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MyextManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MyextManager called, current tenant: {}", getTenant().getTenantID());
	}
