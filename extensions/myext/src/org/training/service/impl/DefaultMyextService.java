...
public class DefaultMyextService implements MyextService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMyextService.class);
	...
	{
		return DefaultMyextService.class.getResourceAsStream("/myext/sap-hybris-platform.png");
	}
