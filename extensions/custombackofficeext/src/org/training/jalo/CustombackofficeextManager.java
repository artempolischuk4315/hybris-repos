...
import org.training.constants.CustombackofficeextConstants;
 ...
 */
public class CustombackofficeextManager extends GeneratedCustombackofficeextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CustombackofficeextManager.class.getName());
	 ...
	 */
	public static CustombackofficeextManager getInstance()
	{
		return (CustombackofficeextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CustombackofficeextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CustombackofficeextManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CustombackofficeextManager called.");
		}
	}
