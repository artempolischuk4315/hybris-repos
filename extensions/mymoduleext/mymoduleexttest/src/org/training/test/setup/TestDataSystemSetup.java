...
import org.training.test.constants.MymoduleextTestConstants;
 ...
 */
@SystemSetup(extension = MymoduleextTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/mymoduleexttest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/mymoduleexttest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/mymoduleexttest/import/cstickets.impex");
			...
			importImpexFile(context, "/mymoduleexttest/import/csquotes.impex");
		}
	}
}
