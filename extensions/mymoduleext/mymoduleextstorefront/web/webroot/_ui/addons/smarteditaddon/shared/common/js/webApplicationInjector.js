! function(t) {
    ...
    var u = o.default.getWhitelistFromScriptElement(c, window),
        s = o.default.convertWhitelistingToRegexp(u);
    parent.postMessage({
        pk: Math.random(),
        gatewayId: i,
        eventId: "loading",
        ...
        if (!o.default.isAllowed(t.origin, window, s)) throw new Error(t.origin + " is not allowed to override this storefront.");
        var e = t.data;
        if (e.gatewayId === i && "bundle" === e.eventId) {
            window.smartedit = window.smartedit || {}, parent.postMessage({
                gatewayId: i,
            ...
            if (n) {
                if (n.properties)
                    for (var a in n.properties) n.properties.hasOwnProperty(a) && (window.smartedit[a] = n.properties[a]);
                var c = document.getElementsByTagName("head")[0];
                if (n.js && n.js.length > 0) {
                    var u = void 0;
                    u = "string" == typeof n.js[0] ? n.js : n.js.filter(function(t) {
                        return !t.namespaceToCheck || !window[t.namespaceToCheck]
                    }).map(function(t) {
                        return t.src
                    }), r.default.injectJS(u)
                }
                n.css && n.css.length > 0 && r.default.injectCSS(c, n.css)
            }
            parent.postMessage({
                gatewayId: i,
    ...
    a = function() {
        ...
        function m(e, n, r) {
            ...
            function v() {
                if (!--h)
                    for (var t in u[c] = 1, i && i(), l) p(t.split("|"), w) && !f(l[t], w) && (l[t] = [])
            }
            return setTimeout(function() {
                f(e, function e(n, r) {
                    return null === n ? v() : (r || /^https?:\/\//.test(n) || !t || (n = -1 === n.indexOf(".js") ? t + n + ".js" : t + n), d[n] ? (c && (s[c] = 1), 2 == d[n] ? v() : setTimeout(function() {
                        e(n, !0)
                    }, 0)) : (d[n] = 1, c && (s[c] = 1), void g(n, v)))
                })
            }, 0), m
        }
        ...
        return m.get = g, m.order = function(t, e, n) {
            ...
            return !f(t, function(t) {
                ...
                return u[t]
            }) ? e() : (r = t.join("|"), l[r] = l[r] || [], l[r][a](e), n && n(o)), m
        }, m.done = function(t) {
            m([null], t)
        }, m
    ...
    var r = function() {
        ...
        return t.startSendingHeartBeatToIframe = function(e) {
            ...
            parent.postMessage({
                ...
                return t.startSendingHeartBeatToIframe(e)
            }, n)
