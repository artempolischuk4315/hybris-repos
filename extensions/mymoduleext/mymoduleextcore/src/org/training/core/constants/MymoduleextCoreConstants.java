...
/**
 * Global class for all MymoduleextCore constants. You can add global constants for your extension into this class.
 */
public final class MymoduleextCoreConstants extends GeneratedMymoduleextCoreConstants
{
	public static final String EXTENSIONNAME = "mymoduleextcore";


	private MymoduleextCoreConstants()
	{
		//empty
	}
