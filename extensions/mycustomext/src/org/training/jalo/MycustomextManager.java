...
/**
 * This is the extension manager of the Mycustomext extension.
 */
public class MycustomextManager extends GeneratedMycustomextManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(MycustomextManager.class);
	 ...
	 */
	public static MycustomextManager getInstance()
	{
		return (MycustomextManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MycustomextConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MycustomextManager() // NOPMD 
	{
		LOG.debug("constructor of MycustomextManager called.");
	}
	...
	public void init()
	{
		LOG.debug("init() of MycustomextManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of MycustomextManager called, current tenant: {}", getTenant().getTenantID());
	}
