...
public class DefaultMycustomextService implements MycustomextService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultMycustomextService.class);
	...
	{
		return DefaultMycustomextService.class.getResourceAsStream("/mycustomext/sap-hybris-platform.png");
	}
