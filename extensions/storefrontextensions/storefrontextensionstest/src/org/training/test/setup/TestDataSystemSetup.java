...
import org.training.test.constants.StorefrontextensionsTestConstants;
 ...
 */
@SystemSetup(extension = StorefrontextensionsTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/storefrontextensionstest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/storefrontextensionstest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/storefrontextensionstest/import/cstickets.impex");
			...
			importImpexFile(context, "/storefrontextensionstest/import/csquotes.impex");
		}
	}
}
