...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(StorefrontextensionsFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(StorefrontextensionsFulfilmentProcessConstants.PARENT_PROCESS);
