...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/storefrontextensionsfulfilmentprocess/test/storefrontextensionsfulfilmentprocess-spring-test.xml"));
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/storefrontextensionsfulfilmentprocess/test/storefrontextensionsfulfilmentprocess-spring-test-fraudcheck.xml"));
		xmlReader
				.loadBeanDefinitions(new ClassPathResource("/storefrontextensionsfulfilmentprocess/test/process/order-process-spring.xml"));
		...
		definitonFactory.add("classpath:/storefrontextensionsfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/storefrontextensionsfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/storefrontextensionsfulfilmentprocess/test/testCatalog.csv", "windows-1252");
	...
	public static void removeProcessDefinitions()
	{
		...
		final XmlBeanDefinitionReader xmlReader = new XmlBeanDefinitionReader((BeanDefinitionRegistry) beanFactory);
		xmlReader.loadBeanDefinitions(
				new ClassPathResource("/storefrontextensionsfulfilmentprocess/test/storefrontextensionsfulfilmentprocess-spring-testcleanup.xml"));
