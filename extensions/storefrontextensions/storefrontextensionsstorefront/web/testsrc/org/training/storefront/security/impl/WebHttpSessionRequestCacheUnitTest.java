...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/storefrontextensionsstorefront/electronics/en",
						"https://electronics.local:9002/storefrontextensionsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/storefrontextensionsstorefront/electronics/en",
						"https://electronics.local:9002/storefrontextensionsstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/storefrontextensionsstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/storefrontextensionsstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/storefrontextensionsstorefront/electronics/en",
						"https://electronics.local:9002/storefrontextensionsstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/storefrontextensionsstorefront",
						"https://electronics.local:9002/storefrontextensionsstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/storefrontextensionsstorefront",
						"https://electronics.local:9002/storefrontextensionsstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/storefrontextensionsstorefront/electronics/en",
						"https://electronics.local:9002/storefrontextensionsstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
